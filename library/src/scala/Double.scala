...
object Double extends AnyValCompanion {
   ...
   *
   *  Runtime implementation determined by `scala.runtime.BoxesRunTime.boxToDouble`. See [here](https://github.com/scala/scala3/blob/main/library/src/scala/runtime/BoxesRunTime.java) for details.
   *
   ...
   *
   *  Runtime implementation determined by `scala.runtime.BoxesRunTime.unboxToDouble`. See [here](https://github.com/scala/scala3/blob/main/library/src/scala/runtime/BoxesRunTime.java) for details.
   *
