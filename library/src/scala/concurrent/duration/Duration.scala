...
object Duration {
  ...
  /**
   *  Extracts length and time unit out of a string, where the format must match the description for [apply(String)](Duration$.apply(s:String)*).
 ...
 * and [Duration.fromNanos(Double)](Duration$.fromNanos(nanos:Double)*)
 *
 * <h2>Ordering</h2>
 *
