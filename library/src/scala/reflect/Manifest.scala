...
/** An opaque descriptor for the type `T` that, beyond the erasure carried by a
 *  `ClassManifest`, also captures the manifests of `T`'s type arguments and
 *  supports approximate subtype comparisons.
 *
