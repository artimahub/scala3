 ...
 *   - [           `dynamics`](dynamics)            enables defining calls rewriting using the [`Dynamic`](scala.Dynamic) trait
...
object language {
   ...
   *  [report any bugs or API inconsistencies](https://github.com/scala/bug/issues)
